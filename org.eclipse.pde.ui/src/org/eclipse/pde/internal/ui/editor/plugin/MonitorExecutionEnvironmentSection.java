...
public class MonitorExecutionEnvironmentSection extends TableSection {
	...
	public MonitorExecutionEnvironmentSection(PDEFormPage page, Composite parent) {
		super(page, parent, Section.DESCRIPTION, new String[] {PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_add, PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_remove, PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_up, PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_down});
		createClient(getSection(), page.getEditor().getToolkit());
	}

	protected void createClient(Section section, FormToolkit toolkit) {
		section.setText(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_title);
		if (isFragment())
			section.setDescription(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_fragmentDesc);
		else
			section.setDescription(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_pluginDesc);
	...
	private void makeActions() {
		fAddAction = new Action(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_add) {
			public void run() {
				handleAdd();
			}
		};
	...
	private void handleAdd() {
		...
		dialog.setTitle(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_dialog_title);
		dialog.setMessage(PDEUIMessages.RequiredMonitorExecutionEnvironmentSection_dialogMessage);
		dialog.create();
